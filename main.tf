...
resource "aws_instance" "app_instance" {
  ...
  tags = {
    Name = "daniel-engineering47-terraform-lesson"
  }
}
resource "aws_instance" "db_instance" {
  ...
  subnet_id                   = "${aws_subnet.app_private_subnet.id}"
  tags = {
    Name = "daniel-engineering47-db-terraform-lesson"
  }
}
resource "aws_security_group" "app_security_group" {
  ...
  tags = {
    Name = "terraform_app_security_group_daniel"
  }
}
resource "aws_security_group" "db_security_group" {
  ...
  tags = {
    Name = "terraform_db_security_group_daniel"
  }
}
